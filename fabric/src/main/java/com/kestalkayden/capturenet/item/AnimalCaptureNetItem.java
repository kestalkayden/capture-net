...
public class AnimalCaptureNetItem extends Item {
    ...
    public InteractionResult interactLivingEntity(ItemStack stack, Player player, LivingEntity target, InteractionHand hand) {
        // Kept as a safety net: the loader's pre-interact hook (UseEntityCallback on Fabric)
        // is what actually wins against mobs that override mobInteract — villagers, allays,
        // and any modded creature with custom right-click. If for some reason that event
